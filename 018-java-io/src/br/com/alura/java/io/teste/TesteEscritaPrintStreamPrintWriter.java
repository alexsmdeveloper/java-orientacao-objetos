...
public class TesteEscritaPrintStreamPrintWriter {
	...
	public static void main(String[] args) throws IOException {
		...
		PrintStream ps = new PrintStream("lorem_printstream.txt");
		ps.println("PrintStream(\"lorem_printstream.txt\");");
		ps.println("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod");
		ps.print("tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam");		
		ps.close();
		
		PrintWriter pw = new PrintWriter("lorem_printwriter.txt");
		
		pw.println("PrintWriter(\"lorem_printwriter.txt\");");
